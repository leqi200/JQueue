...
/**
* @ProjectName:JQueue
* @ClassName: Print_Style_NoTiicket
* @Description: TODO(不出票号的打印)
* @author 萧达光
* @date 2014-5-28 下午01:42:58
* 
* @version V1.0 
*/
public class Print_Style_NoTiicket extends PrintSuper {

	public Print_Style_NoTiicket(String printStr) {
		super(printStr);
	...
	*/
	...
	// String str =
	// "AAGZ00001~广州分公司~中信营业厅~A~综合业务~~5~受理窗口:1、2、3~2014-03-19 16:20:30~你可以登录门户网站(http://www.gdchinamobile.com/gx/)的优惠资讯栏目，随时随地查询各类优惠活动的资讯。~主动营销内容:.............~取票手机:1392103233,请您凭号服务";
	// PrintSuper psa = new Print_Style_NoTiicket(str);
	// psa.print();
