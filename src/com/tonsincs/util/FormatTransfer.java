 ...
 * @Description: 
 *               TODO(通信格式转换;Java和一些windows编程语言如c、c++、delphi所写的网络程序进行通讯时，需要进行相应的转换
 *               高、低字节之间的转换,windows的字节序为低字节开头 linux,unix的字节序为高字节开头 java则无论平台变化，都是高字节开头)
 * @author 萧达光
 * @date 2014-5-28 下午01:28:25
 * 
 * @version V1.0
 */
