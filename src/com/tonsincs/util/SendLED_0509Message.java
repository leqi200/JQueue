 ...
 * @version V1.0
 */
public class SendLED_0509Message {
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public byte[] getsendleddataS(String sendstr, int address) throws UnsupportedEncodingException{
	...
	public static void main(String[] args) throws Exception {
		// SendLED_0509Message led = new SendLED_0509Message("COM3");
